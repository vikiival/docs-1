...
- Windows users should install [WSL](https://docs.microsoft.com/en-us/windows/wsl/).

Additional information about dev environment setup is available [here](/tutorials/development-environment-set-up).
