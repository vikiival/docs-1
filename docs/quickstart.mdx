...
## Step 5: Create the database schema and run the processor
 ...
 The squid we have just built ingests pre-indexed on-chain data from a Kusama Archive. This data is then transformed, as defined by the data handler in `processor.ts`.
