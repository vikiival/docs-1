...
![Building a Docker image of the squid-template](<static/img/.gitbook/assets/docker build.png>)
...
![Accessing the GraphiQL playground of the launched container](<static/img/.gitbook/assets/container graphql.png>)
