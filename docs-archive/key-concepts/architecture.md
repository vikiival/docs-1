...
![Squid and Archive are the main components](</img/.gitbook/assets/Squid Architecture.png>)
...
![Archive components diagram](</static/img/.gitbook/assets/Squid Archive.png>)
