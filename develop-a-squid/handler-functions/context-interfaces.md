...
Developers can use this object in their `EvmvLogHandler` functions like this (for more information about line #2, please take a look at the [EVM Processor page](../evm-support/evm-processor.md#abi-interface-and-decoding)):
